...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:40o99OXc210iEwOWWrPoxg==$YK9vPnSle2x/qquVsHb6LOQsOTBD2mrbMlurqS9CDmk=:k67XyDPViw8BCzfLY1TTs0MmNlldSc9Ft+FXYXhVJN8=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:3RyIurLwGLIB+zav+vkU/w==$9L+3yLzbp4Ly8C3hLxKUEdmk/d8ROnneKrJwCuhstmE=:tQCa7Ry2HoneSZCG+91oFxMPwekiEIUZT1q/yAB6d50=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:slqnSAGAzUzET1lcNXIq5A==$zHZG2ixcnFkMHcHaXkw3c4PU1UFDILDYPlAEnZbr428=:jqD6DdVLK0K2AFubg9cI+7gCKbuWL/iIAh9LzIvj1mg=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:obV+YWIJFwllfXqhTcFGuw==$EUMgg0S9Lz69hEm4GFF1p65n25c/NFf7lhuHM00KEvI=:o4pT1D8jyU6YiDevz6q+kxa1c6waXeTV4XkzJ63b0MI=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:dmN5w7mYjyXh6C1dZo5zDA==$Zc+8LYw1O360JCIC2yEQxc2ulEVlxHvckR9b83Ez+9I=:o0sgbmiroG48763ozzEe7jRLZ1Qr2Yqah+3mTGyYd3g=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:W6xhPdz0e8GcuX3/Rr4XXw==$WrM0z4lLrNihc2nOIs7GlSLkWicE6+kF2FU7dCPWYcw=:t7afhqwWBCAeYU4x4jzeOjDnoA3jUlce/jM0Sb9fS24=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:zLfBM22zlle6X9Kb/W2+JQ==$VchLl+Bziygv/h2dlR+hoFd4/Y/JNZWELwUOfJuXFVI=:h8S5dWcnALXRPtMNdAIDemPsRJ9TwcHak3BNjMwnDRU=';
...
--
-- Name: record_new_visitor(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."record_new_visitor"() RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
--
-- Name: record_pageview(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."record_pageview"() RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
--
-- Name: community_photos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."community_photos" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "nickname" "text" DEFAULT '匿名小朋友'::"text" NOT NULL,
    "city" "text" DEFAULT '未知城市'::"text" NOT NULL,
...
--
-- Name: community_scores; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_photos community_photos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: community_scores community_scores_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."community_scores"
    ADD CONSTRAINT "community_scores_pkey" PRIMARY KEY ("id");


--
-- Name: photo_likes photo_likes_photo_id_session_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."photo_likes"
    ADD CONSTRAINT "photo_likes_photo_id_session_id_key" UNIQUE ("photo_id", "session_id");
...
ALTER TABLE ONLY "public"."site_stats"
    ADD CONSTRAINT "site_stats_pkey" PRIMARY KEY ("stat_date");
...
ALTER TABLE ONLY "public"."photo_likes"
    ADD CONSTRAINT "photo_likes_photo_id_fkey" FOREIGN KEY ("photo_id") REFERENCES "public"."community_photos"("id") ON DELETE CASCADE;
...
--
-- Name: profiles admins_full_access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "admins_full_access" ON "public"."profiles" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: photo_likes anon can insert likes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can insert likes" ON "public"."photo_likes" FOR INSERT TO "anon" WITH CHECK (true);


--
-- Name: community_photos anon can insert photos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can insert photos" ON "public"."community_photos" FOR INSERT TO "anon" WITH CHECK (true);


--
-- Name: community_scores anon can insert scores; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can insert scores" ON "public"."community_scores" FOR INSERT TO "anon" WITH CHECK (true);


--
-- Name: photo_likes anon can select likes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can select likes" ON "public"."photo_likes" FOR SELECT TO "anon" USING (true);


--
-- Name: community_photos anon can select photos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can select photos" ON "public"."community_photos" FOR SELECT TO "anon" USING (true);


--
-- Name: community_scores anon can select scores; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can select scores" ON "public"."community_scores" FOR SELECT TO "anon" USING (true);


--
-- Name: community_photos anon can update likes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can update likes" ON "public"."community_photos" FOR UPDATE TO "anon" USING (true) WITH CHECK (true);


--
-- Name: community_scores anon can update scores; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anon can update scores" ON "public"."community_scores" FOR UPDATE TO "anon" USING (true) WITH CHECK (true);


--
-- Name: site_stats anyone_can_read_stats; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "anyone_can_read_stats" ON "public"."site_stats" FOR SELECT USING (true);


--
-- Name: community_photos; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."community_photos" ENABLE ROW LEVEL SECURITY;

--
-- Name: community_scores; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."community_scores" ENABLE ROW LEVEL SECURITY;

--
-- Name: site_stats no_direct_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "no_direct_write" ON "public"."site_stats" TO "authenticated", "anon" USING (false);


--
-- Name: photo_likes; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: site_stats; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."site_stats" ENABLE ROW LEVEL SECURITY;

--
-- Name: profiles users_update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "users_update_own" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK ((NOT ("role" IS DISTINCT FROM "public"."get_user_role"("auth"."uid"()))));


--
-- Name: profiles users_view_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "users_view_own" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));
...
--
-- Name: objects anon can upload community; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "anon can upload community" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'community'::"text"));
...
--
-- Name: objects poem_images_auth_delete; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "poem_images_auth_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'poem-images'::"text"));


--
-- Name: objects poem_images_auth_upload; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "poem_images_auth_upload" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'poem-images'::"text"));


--
-- Name: objects poem_images_public_read; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "poem_images_public_read" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'poem-images'::"text"));


--
-- Name: objects public can read community; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "public can read community" ON "storage"."objects" FOR SELECT TO "anon" USING (("bucket_id" = 'community'::"text"));
...
--
-- Name: objects 允许匿名上传音频; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "允许匿名上传音频" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'generated-audio'::"text"));


--
-- Name: objects 允许匿名读取音频; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "允许匿名读取音频" ON "storage"."objects" FOR SELECT TO "anon" USING (("bucket_id" = 'generated-audio'::"text"));
...
generated-audio	generated-audio	\N	2026-06-03 09:38:55.523827+00	2026-06-03 09:38:55.523827+00	t	f	\N	\N	\N	STANDARD
community	community	\N	2026-06-14 06:52:34.36185+00	2026-06-14 06:52:34.36185+00	t	f	\N	\N	\N	STANDARD
poem-images	poem-images	\N	2026-06-14 09:10:25.240071+00	2026-06-14 09:10:25.240071+00	t	f	\N	\N	\N	STANDARD
\.
